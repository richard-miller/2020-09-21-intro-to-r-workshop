...
# Likert scales: very likely, neutral, unlikely, etc
...
# some date cannot be converted to date - because some months don't have 31 days
...
surveys[ is.na(surveys$date), c("record_id", "year", "month", "day") ]
